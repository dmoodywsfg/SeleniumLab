...
public class AdventureTours {
	...
	public void bookFlight() throws InterruptedException {
		...
		// ===============================
		// --------------------------------
		// Old School Code for Walking Tip Table, aren't you glad you have XPath?
		//
		...
		Assert.assertEquals("Find a Flight: Adventure Tours:", driver.getTitle());
		...
		Assert.assertEquals("Select a Flight: Adventure Tours", driver.getTitle());
		...
		// Use Form WebElement location to work on our departure flight, 
		// use XPath to get list of out flights, 
		// then loop through them to find the radio button for Unified Airlines
		//
		List<WebElement> depFlights = 
				form.findElements(By.xpath("//input[@name='outFlight']"));
		...
		//Use Form WebElement location to work on our return flight,use XPath to find it in one statement
		//
		WebElement uaFlight = form.findElement(
				By.xpath("//input[@name='inFlight'][contains(@value, 'Unified Airlines')]"));
...
//		}
		...
		Assert.assertEquals("Passenger Info: Adventure Tours", driver.getTitle());
