...
public class WebDriverTests {
	...
	nav.to("http://www.thetestroom.com/webapp/");	// use URL String to navigate
	System.out.println("Displaying page " + driver.getTitle() + driver.getCurrentUrl());
	Thread.sleep(100);

	URL url = new URL("http://localhost:8080/mtours/");
	nav.to(url);									// Use URL Obj to navigate
	System.out.println("Displaying page " + driver.getTitle() + driver.getCurrentUrl());
	Thread.sleep(100);
